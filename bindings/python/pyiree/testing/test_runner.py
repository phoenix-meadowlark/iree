...
# flags.DEFINE_string(
#     "base_dir", "/tmp/iree/test/",
#     "The base directory to store all test artifacts in. "
#     "Ignored if --use_tmp_dir=True")
# flags.DEFINE_bool(
#     "use_tmp_dir", False,
#     "Whether or not to store all test artifacts in a temporary "
#     "directory and delete after the test finishes.")
# flags.DEFINE_bool(
#     "fail_on_unexpected_success", False,
#     "Whether to treat unexpected successful compilation or "
#     "execution as a test failure.")
# flags.DEFINE_bool(
#     "log_expected_failures", False,
#     "Controls whether the errors from expected failures are "
#     "suppressed.")
FLAGS = flags.FLAGS
